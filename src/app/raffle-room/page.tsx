...
function RaffleRoomContent() {
  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-screen bg-gray-900 text-white p-6">
      ...
      {/*
        We have a grid for the main content:
        - 1 column on mobile
        - 2 columns on md+ screens
      */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-6 w-full max-w-6xl">
        {/*
          LEFT COLUMN:
          1) The picks grid
          2) The "Go to Live Tracker" button (appears at the bottom of this column if isRaffleComplete)
        */}
        <div>
          {/* The 30 picks (slots) */}
          ...
          {/* When the raffle completes, button is right below the picks */}
          {isRaffleComplete && (
