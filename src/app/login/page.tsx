...
function LoginForm() {
  ...
  const handleMagicLink = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      setMessage('Check your email for the magic link! Be sure to check your spam folder and add admin@rumbleraffle.com to your contacts.')
    }
    setLoading(false)
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900">
      ...
      <div className="flex items-center justify-center px-4 py-12">
        ...
        <p className="text-center text-sm text-gray-400">
          ...
          <Link href={`/signup?redirect=${encodeURIComponent(redirect)}`} className="text-purple-400 hover:text-purple-300 font-medium">
            Sign up
          </Link>
        </p>
        </div>
